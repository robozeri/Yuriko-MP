...
class Enchantment{
	...
	public static function init(){
		...
		// TODO: I DON'T KNOW ENCHANTMENTS' RARITY, SO I BASED THE RARITY ON MY MINECRAFTER EXPERIENCE. -AryToNeX
		...
		self::$enchantments[self::TYPE_WATER_BREATHING] = new Enchantment(self::TYPE_WATER_BREATHING, "%enchantment.water.breathing", self::RARITY_COMMON, self::ACTIVATION_EQUIP, self::SLOT_HEAD);
		...
		self::$enchantments[self::TYPE_WEAPON_SHARPNESS] = new Enchantment(self::TYPE_WEAPON_SHARPNESS, "%enchantment.weapon.sharpness", self::RARITY_COMMON, self::ACTIVATION_HELD, self::SLOT_SWORD);
		...
		self::$enchantments[self::TYPE_WEAPON_KNOCKBACK] = new Enchantment(self::TYPE_WEAPON_KNOCKBACK, "%enchantment.weapon.knockback", self::RARITY_COMMON, self::ACTIVATION_HELD, self::SLOT_SWORD);
		...
		self::$enchantments[self::TYPE_WEAPON_LOOTING] = new Enchantment(self::TYPE_WEAPON_LOOTING, "%enchantment.weapon.looting", self::RARITY_COMMON, self::ACTIVATION_HELD, self::SLOT_SWORD);
		self::$enchantments[self::TYPE_MINING_EFFICIENCY] = new Enchantment(self::TYPE_MINING_EFFICIENCY, "%enchantment.mining.efficiency", self::RARITY_COMMON, self::ACTIVATION_HELD, self::SLOT_PICKAXE);
		self::$enchantments[self::TYPE_MINING_SILK_TOUCH] = new Enchantment(self::TYPE_MINING_SILK_TOUCH, "%enchantment.mining.silktouch", self::RARITY_COMMON, self::ACTIVATION_HELD, self::SLOT_PICKAXE);
		self::$enchantments[self::TYPE_MINING_DURABILITY] = new Enchantment(self::TYPE_MINING_DURABILITY, "%enchantment.mining.durability", self::RARITY_COMMON, self::ACTIVATION_HELD, self::SLOT_TOOL);
		...
		self::$enchantments[self::TYPE_BOW_FLAME] = new Enchantment(self::TYPE_BOW_FLAME, "%enchantment.bow.flame", self::RARITY_COMMON, self::ACTIVATION_HELD, self::SLOT_BOW);
		...
		self::$enchantments[self::TYPE_FISHING_LURE] = new Enchantment(self::TYPE_FISHING_LURE, "%enchantment.fishing.lure", self::RARITY_COMMON, self::ACTIVATION_HELD, self::SLOT_FISHING_ROD);
	}
